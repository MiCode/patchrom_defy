...
.field private static final FACTORY_RESET_DELAY:I = 0xe
...
.field private static final MANUAL_LOCK:I = 0x1f5
...
.field private static final SCREENSAVER_INTERRUPTED:I = 0x1f4
...
.field private mUserLockedIntent:Landroid/content/Intent;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/os/LocalPowerManager;)V
    ...
    iput-boolean v9, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mNeedToReshowWhenReenabled:Z

    iput-boolean v9, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z

    iput-boolean v9, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mHidden:Z

    iput-boolean v9, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mKeyboardOpen:Z
    ...
    iput-boolean v9, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mWaitingUntilKeyguardVisible:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->sfx:Landroid/media/Ringtone;
    ...
    const-string v0, "com.motorola.internal.intent.action.SCREENSAVER_INTERRUPTED"

    invoke-virtual {v8, v0}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v0, "com.motorola.internal.intent.action.WEBTOP_KEYGUARD"
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mUserLockedIntent:Landroid/content/Intent;
    ...
    invoke-static {v6, v0, v9}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
...
.method static synthetic access$2000(Lcom/android/internal/policy/impl/KeyguardViewMediator;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->doFactoryReset()V
...
.method static synthetic access$2100(Lcom/android/internal/policy/impl/KeyguardViewMediator;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->handleScreensaverInterrupted()V
...
.method static synthetic access$2200(Lcom/android/internal/policy/impl/KeyguardViewMediator;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->handleManualLock()V
...
.method static synthetic access$700(Lcom/android/internal/policy/impl/KeyguardViewMediator;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method private doFactoryReset()V
    ...
    .local v0, intent_mc:Landroid/content/Intent;
...
.method private doKeyguard()V
    ...
    invoke-static {v4, v5}, Lcom/motorola/rdc/RdcUtils;->submitRdcMetric_AH44(Landroid/content/Context;Z)V
...
.method private handleKeyguardDone(Z)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$MotoKeyguardUpdateMonitor;->setlockNowFlag(Z)V
...
.method private handleManualLock()V
    .locals 2
    ...
    const-string v1, "handleManualLock"
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/KeyguardViewManager;->onManualLock()V
...
.method private handleScreensaverInterrupted()V
    .locals 3
    ...
    const-string v1, "handleScreensaverInterrupted"
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/KeyguardViewManager;->onScreensaverInterrupted()Z
    ...
    iget-object v1, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mUserLockedIntent:Landroid/content/Intent;
...
.method private notifyFactoryReset()V
    .locals 5
    ...
    .local v0, mDelayofFactoryReset:I
    :try_start_0
    iget-object v2, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mContext:Landroid/content/Context;
...
.method private playSounds(Z)V
    ...
    iget-boolean v4, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mSuppressNextLockSound:Z
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->sfx:Landroid/media/Ringtone;
    ...
    .local v3, whichSound:Ljava/lang/String;
    :goto_1
    ...
    iput-object v4, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->sfx:Landroid/media/Ringtone;
    ...
    .end local v3           #whichSound:Ljava/lang/String;
    :cond_3
    ...
    .restart local v3       #whichSound:Ljava/lang/String;
    :cond_4
    const-string v4, "KeyguardViewMediator"
    ...
    const-string v5, "playSounds: failed to load ringtone from uri: "
    ...
    const-string v5, "playSounds: could not parse Uri: "
    ...
    const-string v5, "playSounds: whichSound = "
    ...
    const-string v5, "; soundPath was null"
...
.method public isSecurityLocked()Z
    ...
    const-string v0, "FALSE - isSecurityLocked"
    ...
    const-string v0, "Showing-Let Manager decide"
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/KeyguardViewManager;->isSecurityLocked()Z
...
.method public keyguardDone(ZZ)V
    ...
    invoke-static {v1, v2}, Lcom/motorola/rdc/RdcUtils;->submitRdcMetric_AH44(Landroid/content/Context;Z)V
...
.method public onScreenTurnedOff(I)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/internal/policy/impl/KeyguardViewManager;->setKeyguardViewManagerScreenOn(Z)V
...
.method public onSystemReady()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->isDeviceNeedFactoryReset()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->notifyFactoryReset()V
